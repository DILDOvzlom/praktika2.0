...
echo'</span></td></tr>
<tr><td class=row1 valign=top><span class=genmed><b>Сообщение</b><br><br>Если не грузит картинки то сервак упал<br><br>ВКЛЮЧИТЕ ВПН :<br>
...
print"<a name='add' href='#add' onclick=\"window.open('tools.php?event=moresmiles','smiles','width=450,height=300,left=50,top=300,toolbar=0,status=0,border=0,scrollbars=1')\"></a></tr></td></table><br>* Возможно мы и не делали загрузку картинок)</span></td>
...
<tr>
<th width=62% colspan=2 class=thCornerL height=25>список историй</th>
